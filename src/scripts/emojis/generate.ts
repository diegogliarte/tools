...
const OUT_PATH = path.join('src', 'lib', 'data', 'emojis', 'emoji-search.ts');
...
function writeOutput(emojis: EmojiItem[]) {
	...
	const file = `// Generated by src/scripts/emojis/generate.ts
...
export const EMOJI_SEARCH_ITEMS = ${JSON.stringify(emojis, null, '\t')} as const satisfies readonly EmojiSearchItem[];
`;
